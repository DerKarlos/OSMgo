...
import { log, dbg, httpx, keepDo, mlm, /*curGeoPosLat, curGeoPosLon*/ } from './main.js';
import { maps } from './render.js';
import { Way } from './render_way.js';
import { GetLat2z, GetLon2x } from './osm.js'

///// MAIN+Code /////
export function KeepRight() {
	...
	//------------------------------------------------
	this.LoadAndPlace = function (left, right, bottom, top_) {
		/*with (this)*/ {
